...
class TemplateConfig(BaseModel):
    ...
    relative to the SWE_AGENT_CONFIG_ROOT (if set) or the SWE2 repository root
    """
    ...
    def warnings(self) -> Self:
        ...
        if not self.system_template or not self.instance_template:
            logger.warning(
                ...
                " overwriting the default config? See https://github.com/ScaryMonster1331/SWE2usage/cl_tutorial/"
...
class DefaultAgent(AbstractAgent):
    ...
    def _add_templated_messages_to_history(
        ...
        # freeze in the agent. See https://github.com/ScaryMonster1331/SWE2/issues/901 .
