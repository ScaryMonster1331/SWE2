...
More on union types: [link=https://github.com/ScaryMonster1331/SWE2usage/cl_tutorial/#union-types]https://github.com/ScaryMonster1331/SWE2usage/cl_tutorial/#union-types[/link]
"""
...
class BasicCLI:
    def __init__(
        ...
        *,
        ...
        """This class implements a basic CLI for SWE2. It is based on pydantic-settings, i.e., takes
