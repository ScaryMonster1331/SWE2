"""[cyan][bold]Run SWE2 on a single instance taken from github or similar.[/bold][/cyan]
...
sweagent run --config config/default.yaml --agent.model.name "gpt-4o" \\
    --env.repo.github_url=https://github.com/SWE2/test-repo/ \\
    --problem_statement.github_url=https://github.com/SWE2/test-repo/issues/1
[/green]
